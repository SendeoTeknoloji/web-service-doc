...
|AdditionalValue|string|Zorunlu Değil|BarcodeLabelType alanında gönderilen bilgiye göre değişmektedir.Bu kısma girilen değer barkodun alt kısmında bulunan 2\*10’luk alanda gösterilmektedir.|BarcodeLabelType bilgisine göre “ZPL”,”HTML” veya “TEXT” formatında bilgi iletilebilir.Barkod içerisinde örnek "additionalValue": "^FO20,730^A0N,30,30^FDÖRNEK-AÇIKLAMA^FS" alanı ile iletilmelidir.|
